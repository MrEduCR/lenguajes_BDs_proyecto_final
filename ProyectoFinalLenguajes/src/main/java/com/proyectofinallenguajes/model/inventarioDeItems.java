...
public class inventarioDeItems {
    ...
    public inventarioDeItems(int id_lote, int id_item, BigDecimal cantidad,
                             LocalDateTime fecha_ingreso, LocalDateTime fecha_vencimiento) {
    ...
    public inventarioDeItems(int id_lote, int id_item, String producto, BigDecimal cantidad,
                             LocalDateTime fecha_ingreso, LocalDateTime fecha_vencimiento) {
        this.id_lote = id_lote;
        this.id_item = id_item;
